...
export class Backend implements backendInterface {
    ...
    async createBioPage(arg0: TemplateId, arg1: string, arg2: string, arg3: Array<SocialHandle>, arg4: Array<Link>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createBioPage(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFamousInfluencers(arg0: Category): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFamousInfluencers(arg0);
    ...
    async getSharedBio(arg0: ShareId): Promise<BioPage | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSharedBio(arg0);
    ...
    async getTemplatesByCategory(arg0: Category): Promise<Array<Template>> {
        if (this.processError) {
            try {
    ...
    async hasActiveSubscription(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasActiveSubscription();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveFamousInfluencer(arg0: Category, arg1: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveFamousInfluencer(arg0, to_candid_UserProfile_n28(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async subscribe(arg0: SubscriptionTier, arg1: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.subscribe(to_candid_SubscriptionTier_n30(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadTemplate(arg0: string, arg1: Category, arg2: string, arg3: ExternalBlob, arg4: Uint8Array): Promise<TemplateId> {
        if (this.processError) {
            try {
...
function from_candid_TemplateStatus_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TemplateStatus): TemplateStatus {
    return from_candid_variant_n14(_uploadFile, _downloadFile, value);
}
async function from_candid_Template_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Template): Promise<Template> {
...
function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SubscriptionTier]): SubscriptionTier | null {
    return value.length === 0 ? null : from_candid_SubscriptionTier_n21(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BioPage]): BioPage | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_TemplateStatus_n13(_uploadFile, _downloadFile, value.status),
        thumbnail: await from_candid_ExternalBlob_n15(_uploadFile, _downloadFile, value.thumbnail),
        editableContent: value.editableContent,
        name: value.name,
        createdAt: value.createdAt,
        creatorId: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.creatorId)),
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        subscription: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.subscription)),
        userId: value.userId,
        subscriptionExpiry: record_opt_to_undefined(from_candid_opt_n23(_uploadFile, _downloadFile, value.subscriptionExpiry)),
        email: value.email,
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "published" in value ? TemplateStatus.published : "unlisted" in value ? TemplateStatus.unlisted : value;
}
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pro" in value ? SubscriptionTier.pro : "premium" in value ? SubscriptionTier.premium : value;
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Template>): Promise<Array<Template>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Template_n11(_uploadFile, _downloadFile, x)));
}
...
function to_candid_SubscriptionTier_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubscriptionTier): _SubscriptionTier {
...
function to_candid_record_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        subscription: value.subscription ? candid_some(to_candid_SubscriptionTier_n30(_uploadFile, _downloadFile, value.subscription)) : candid_none(),
        userId: value.userId,
...
function to_candid_variant_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubscriptionTier): {
    pro: null;
} | {
    premium: null;
} {
